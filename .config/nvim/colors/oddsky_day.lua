...
M.set = function(colors)
    ...
    hl("StatusLine", { fg = colors.fg2, bg = colors.bg3, italic = true })
    hl("StatusLineNC", { fg = colors.fg2, bg = colors.bg2, italic = true })
    hl("TabLine", { fg = colors.fg2, bg = colors.bg2 })
    ...
    hl("TelescopePromptBorder", { fg = colors.fg2 })
    hl("TelescopeResultsBorder", { fg = colors.fg2 })
    hl("TelescopePreviewBorder", { fg = colors.fg2 })
    hl("TelescopeNormal", { fg = colors.fg1 })
    hl("TelescopeSelection", { fg = colors.fg1, bg = colors.bg2 })
    hl("TelescopeMultiSelection", { fg = colors.fg1 })
    hl("TelescopeMatching", { fg = colors.green })
    hl("TelescopePromptPrefix", { fg = colors.fg1, bold = true })
