...
M.load = function(colors)
    ...
    hl("StatusLine", { fg = colors.bg1, bg = colors.blue, italic = true })
    hl("TabLine", { fg = colors.fg2, bg = colors.bg1 })
    hl("TabLineFill", { fg = colors.fg2, bg = colors.bg1 })
    hl("TablineSel", { fg = colors.fg1, bg = colors.bg4 })
    ...
    -- python
    hl("@attribute.builtin.python", { fg = colors.fg1 })
    hl("@attribute.python", { fg = colors.fg1 })
    hl("@constant.builtin.python", { fg = colors.violet })
